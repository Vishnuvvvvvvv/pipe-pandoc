...
Here is some **bold,** *italic,* ***bold-italic,*** underlined and ~~struck out~~ text. Then, we have a super script and a sub script . Now we see some red, green and blue text. Some text with a yellow highlight. Some text in a box. Some text in inverse video.
...
| One
Three \| Two<br>One
Three \| Four |To the left is a table inside a table, with some cells merged.|
|--------------------------------|------------------------------------------------------------------|
...
5. One
6. Two
7. We now resume our normal programming
8. Four
